...
public class JSONLD {
	...
	public struct TermDefinition: Equatable {
	...
	public class Context {
		...
		func clone() -> Context {
			let c = Context(originalBaseURL: originalBaseURL, base: base)
			c.vocab = vocab
			c.language = language
	...
	public enum TextDirection: String, Equatable {
		case rtl
		case ltr
	...
	func loadDocument(url: URL, profile _: String, requestProfile _: Set<String>) -> (Data?, URLResponse?, Error?) {
